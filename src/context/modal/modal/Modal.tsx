  ...
  return (
    ...
    >
      <div
        ref={nodeRef}
        style={{ marginTop: 0 }}
        className={` fixed w-full h-screen top-0 left-0 z-[70] flex justify-center items-center py-16 bg-[#0000005e] backdrop-blur-[1px]`}
      >
        <div
          onClick={() => closeModal()}
        ...
        >
          ...
          {props.delete && (
            <svg
              className="w-40 mx-auto fill-zinc-900"
              viewBox="0 0 512 512"
            >
