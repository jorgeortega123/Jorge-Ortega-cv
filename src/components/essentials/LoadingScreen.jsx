  ...
  return (
    <AnimatePresence>
      {!isLoadedBody && (
        ...
        >
          <div className=" z-[7] absolute top-[-56px] w-full h-screen bg-[#0f2d51] flex flex-col ">
            <span className="bg-white"></span>

            <div className="my-auto mx-auto">
              <div>
                <div className="text-center">
                  <p className="text-[3vh] font-bold">Jorge Ortega</p>
                ...
                >
                  <title>Jorge Ortega's portfolio</title>
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="hidden text-[10px] ">Loading resources...</p>
                </div>
              </div>
            </div>
          </div>
...
//     transition={{ type: "tween" }}
//   >
//     <div className=" z-[7] absolute top-12 w-full h-screen bg-[#0f2d51] text-[54px] flex justify-center">

//       <div>asdjkashdlasdjk</div>
//       <span className="bg-white"></span>
//       <div className="relative w-full h-[1px] rounded-2xl bg-transparent">
//         <div className=" loadServer h-[1px] bg-white rounded-2xl">sasd</div>
//       </div>
//     </div>
//   </motion.div>
// )}
