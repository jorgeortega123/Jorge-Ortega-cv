...
export default function Button({
  ...
  return (
    <div
     onClick={onClick}
      {...props}
      className={`cv-button blockAllSelect overflow-x-hidden font-[subtitle] bg-[#3add11] text-[#0f2d51] flex  items-center text-[15px] cursor-pointer rounded-[6px] p-[${spaceY}px] pl-[18px] pr-[8px] ${className}`}
    >
      <p className="">{text}</p>
      <div className="">
