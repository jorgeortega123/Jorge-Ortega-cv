        ...
        <div className="p-4 select-none ">
          ...
          <div className="grid grid-cols-4 gap-2 justify-center items-center my-3">
            {images.frontend.map((e) => {
              return (
                <div className={` h-[86px] w-full flex flex-col  text-center items-center skills-container hover:text-[${e.color}] hover:drop-shadow-[5px_6px_16px_${e.color}] `}>
                  <p className="text-skill  lg:text-[22px] xl:text-[25px]">{e.text}</p>
